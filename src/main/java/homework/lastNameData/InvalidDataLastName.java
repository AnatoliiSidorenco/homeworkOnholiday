...
public class InvalidDataLastName {
    ChromeDriver driver;
    ...
    @Test
    public void invalidDataLastName1() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("12)(");
        sleep(500);
    }

    @Test
    public void invalidDataLastName2() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys(" ");
        sleep(500);
    }

    @Test
    public void invalidDataLastName3() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("wInTer");
        sleep(500);
    }

    @Test
    public void invalidDataLastName4() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("123");
        sleep(500);
    }

    @Test
    public void invalidDataLastName5() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("$%^&*,.:");
        sleep(500);
    }
    ...
    @Test
    public void invalidDataLastName6() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("алфавит");
        sleep(500);
    }

    @Test
    public void invalidDataLastName7() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("win89");
        sleep(500);
    }

    @Test
    public void invalidDataLastName8() throws InterruptedException {
        WebElement secondNameInputField = driver.findElement(By.xpath("// div[@class='first_block']//input[@class='form-control second']"));
        secondNameInputField.sendKeys("hero*");
        sleep(500);
    }
